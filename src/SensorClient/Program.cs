...
var configs = new List<SensorConfig>
{
    ...
    new SensorConfig { SensorId = "SENSOR-02", TempMin = 200, TempMax = 350, InitialQuality = DataQuality.GOOD, Alarms = new AlarmThresholds { Priority1 = 280, Priority2 = 310, Priority3 = 340 } },
    ...
    new SensorConfig { SensorId = "SENSOR-04", TempMin = 200, TempMax = 350, InitialQuality = DataQuality.GOOD, Alarms = new AlarmThresholds { Priority1 = 280, Priority2 = 310, Priority3 = 340 } },
